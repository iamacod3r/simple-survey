...
namespace Survey.Domain.Implements
{
    public class SurveyService : ISurveyService
    {
        ...
        public async Task<Model.Output.Survey> CreateSurvey(Model.Input.Survey survey)
        {
            ...
            newSurveyEntity = await SurveyRepository.CreateSurvey(newSurveyEntity);
        ...
        {
            var survey = await SurveyRepository.GetSurveyById(question.SurveyId);
            if (survey != null)
            {
                ...
                newQuestion = await SurveyRepository.AddQuestionToSurvey(question.SurveyId, newQuestion);
        ...
        public async Task<List<Model.Output.Question>> CreateSurveyQuestions(ICollection<Model.Input.Question> questions)
        {
        ...
        {
            var surveyEntity = await SurveyRepository.GetSurveyById(surveyId);
        ...
        public async Task<bool> UpdateQuestion(Model.Input.Question question)
        {
            ...
            if (survey.Questions != null && survey.Questions.Any())
            {
                ...
                if (ques != null)
                {
                    ...
                    return await SurveyRepository.UpdateQuestion(question.SurveyId, ques);
                }
            }
            return false;
        }
        ...
        public async Task<bool> SaveAnswer(Model.Input.Answer answer)
        {
            ...
            var result = await SurveyRepository.SaveSurveyQuestionAnswer(answerEntity);
        ...
        public async Task<SurveyResult> GetSurveyResult(int surveyId)
        {
            ...
            var savedAnswers = await SurveyRepository.GetSurveyQuestionAnswers(surveyId);
